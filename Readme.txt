...
This project is based on the library GLCDv3, which is now deprecated and doesn't work with the newest Arduino's board 
link to the library(http://playground.arduino.cc/Code/GLCDks0108).
